...
interface ProductFieldMapMapper {
     ...
     * @param fieldMap A map where keys are [ProductField] and values are their corresponding string
     *   values.
        ...
        return Product(
            ...
            nutrients =
                Nutrients(
                    ...
                    monounsaturatedFats =
                        fieldMap[ProductField.MONOUNSATURATED_FATS]?.toFloatOrNull(),
                    polyunsaturatedFats =
                        fieldMap[ProductField.POLYUNSATURATED_FATS]?.toFloatOrNull(),

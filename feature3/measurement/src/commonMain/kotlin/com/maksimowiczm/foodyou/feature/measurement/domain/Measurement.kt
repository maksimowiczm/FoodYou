...
sealed interface Measurement {
    ...
    @JvmInline value class Gram(val value: Float) : Measurement

    @JvmInline value class Milliliter(val value: Float) : Measurement
    ...
    companion object {
        ...
        fun equal(a: Measurement, b: Measurement): Boolean =
            when {
...
fun Measurement.Companion.from(type: MeasurementType, rawValue: Float): Measurement =
    when (type) {
...
object MeasurementSerializer : KSerializer<Measurement> {
    override val descriptor: SerialDescriptor =
        buildClassSerialDescriptor("Measurement") {
            element<String>("type")
            element<Float>("value")
        }

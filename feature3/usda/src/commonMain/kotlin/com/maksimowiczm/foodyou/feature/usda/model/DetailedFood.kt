...
internal data class DetailedFood(
    ...
    override val servingSize: Double? = null,
    @SerialName("servingSizeUnit")
    override val servingSizeUnit: String? = null,
    @SerialName("packageWeight")
    override val packageWeight: String? = null,
    @SerialName("foodNutrients")
    override val foodNutrients: List<DetailedFoodNutrient>
) : Food

@Serializable
internal data class DetailedFoodNutrient(
    @SerialName("nutrient")
    val nutrient: DetailedNutrient,
    @SerialName("amount")

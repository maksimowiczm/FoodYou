...
internal class FoodSearchObserveRecipeUseCase(private val queryBus: QueryBus) {
    fun observe(id: FoodId.Recipe): Flow<Recipe?> = queryBus.dispatch<Recipe>(ObserveFoodQuery(id))
}

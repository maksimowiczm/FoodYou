...
internal class FoodEventMapperImpl : FoodEventMapper {
    ...
    override fun toModel(entity: FoodEventEntity): FoodEvent =
        with(entity) {
            val date =
            ...
            when (type) {
                ...
                FoodEventType.Downloaded -> FoodEvent.Downloaded(date = date, url = extra)
                ...
                FoodEventType.Edited -> {
                    ...
                    FoodEvent.Edited(oldFood = Json.decodeFromString(extra), date = date)
                }
    ...
    override fun toEntity(model: FoodEvent, foodId: FoodId) =
        with(model) {

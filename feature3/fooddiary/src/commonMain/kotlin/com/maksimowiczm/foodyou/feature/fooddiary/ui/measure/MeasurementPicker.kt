...
@Composable
internal fun MeasurementPicker(state: MeasurementPickerState, modifier: Modifier = Modifier) {
...
@Composable
private fun MeasurementType.stringResource(): String = when (this) {
...
@Composable
internal fun rememberMeasurementPickerState(
...
internal class MeasurementPickerState(
    val suggestions: Set<Measurement>,

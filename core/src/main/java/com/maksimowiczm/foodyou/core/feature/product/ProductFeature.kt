...
import com.maksimowiczm.foodyou.core.feature.product.network.openfoodfacts.OpenFoodFactsRemoteDatabase
...
private val productsModule = module {
    ...
    singleOf(::OpenFoodFactsRemoteDatabase).bind<ProductsRemoteDatabase>()
}

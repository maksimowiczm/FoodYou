...
fun SearchHome(
    ...
    // Collect in view model scope to wierd behavior when recomposing
    val queryResult = viewModel.pages
        .collectAsLazyPagingItems(viewModel.viewModelScope.coroutineContext)

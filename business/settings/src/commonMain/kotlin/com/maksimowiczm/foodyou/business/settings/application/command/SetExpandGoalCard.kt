...
data class SetExpandGoalCardCommand(val newValue: Boolean) : Command
...
internal class SetExpandGoalCardCommandHandler(private val localSettings: LocalSettingsDataSource) :
    ...
    override val commandType: kotlin.reflect.KClass<SetExpandGoalCardCommand>
        get() = SetExpandGoalCardCommand::class

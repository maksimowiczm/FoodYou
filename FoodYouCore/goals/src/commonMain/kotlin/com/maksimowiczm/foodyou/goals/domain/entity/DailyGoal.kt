...
data class DailyGoal(
    ...
    companion object {
        ...
        val defaultGoals: DailyGoal
            get() {
                val energy = 2000
                val proteins = NutrientsHelper.proteinsPercentageToGrams(energy, .2)
                val carbohydrates = NutrientsHelper.carbohydratesPercentageToGrams(energy, .50)
                val fats = NutrientsHelper.fatsPercentageToGrams(energy, .30)

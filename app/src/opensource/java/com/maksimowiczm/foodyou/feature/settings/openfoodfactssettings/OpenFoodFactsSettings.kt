...
class OpenFoodFactsSettings(
    private val openFoodFactsSettingsRepository:
    Module.() -> KoinDefinition<OpenFoodFactsSettingsRepository>,
    private val systemInfoRepository: Module.() -> KoinDefinition<SystemInfoRepository>
) : Feature.Settings,
    SearchHintBuilder {

...
import com.maksimowiczm.foodyou.feature.diary.data.model.NutrimentsAsGrams
...
class CaloriesGoalFormState(
    ...
    fun onProteinsGramsChanged(newValue: TextFieldValue) {
        onGramsChanged(newValue) { value, grams ->
            ...
            val percentage = grams.toFloat() * NutrimentsAsGrams.PROTEINS / dailyGoals.calories
    ...
    fun onCarbohydratesGramsChanged(newValue: TextFieldValue) {
        onGramsChanged(newValue) { value, grams ->
            ...
            val percentage =
                grams.toFloat() * NutrimentsAsGrams.CARBOHYDRATES / dailyGoals.calories
    ...
    fun onFatsGramsChanged(newValue: TextFieldValue) {
        onGramsChanged(newValue) { value, grams ->
            ...
            val percentage = grams.toFloat() * NutrimentsAsGrams.FATS / dailyGoals.calories

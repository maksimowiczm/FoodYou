package com.maksimowiczm.foodyou.feature.camera.ui
...
import com.maksimowiczm.foodyou.feature.camera.data.CameraPreferences
...
class CameraBarcodeScannerViewModel(private val dataStore: DataStore<Preferences>) : ViewModel() {
    ...
    companion object {
        private val key = CameraPreferences.cameraPermissionRequests
    }
}

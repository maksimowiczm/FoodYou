...
@DatabaseView(
    ...
    Recipe AS (
        SELECT
            ...
            NULL AS brand,
            NULL AS barcode,
            rn.calories / rw.totalWeight * 100 AS calories,
            rn.proteins / rw.totalWeight * 100 AS proteins,
            rn.carbohydrates / rw.totalWeight * 100 AS carbohydrates,
            rn.fats / rw.totalWeight * 100 AS fats,

...
import com.maksimowiczm.foodyou.feature.diary.domain.ObserveMealByDateUseCase.Meal
import com.maksimowiczm.foodyou.feature.diary.domain.ObserveMealByDateUseCase.Product
...
fun MealScreen(
    ...
    val meal by viewModel.observeMeal(date, mealId).collectAsStateWithLifecycle(null)
...
private fun ModalSheetContent(
    model: ObserveMealByDateUseCase.Product,
    onEditEntry: () -> Unit,
    onDeleteEntry: () -> Unit
) {

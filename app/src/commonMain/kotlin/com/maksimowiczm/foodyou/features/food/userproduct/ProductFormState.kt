package com.maksimowiczm.foodyou.features.food.userproduct
        ...
        remember(product) {
            when (val servingQuantity = product?.servingQuantity) {
                is AbsoluteQuantity.Volume ->
                    when (servingQuantity.volume.unit) {
                        VolumeUnit.Milliliters ->
                            servingQuantity.volume.milliliters to QuantityUnit.Milliliter

                        VolumeUnit.FluidOunces ->
                            servingQuantity.volume.fluidOunces to QuantityUnit.FluidOunce
                    }

                is AbsoluteQuantity.Weight ->
                    when (servingQuantity.weight.unit) {
                        WeightUnit.Grams -> servingQuantity.weight.grams to QuantityUnit.Gram

                        WeightUnit.Ounces -> servingQuantity.weight.ounces to QuantityUnit.Ounce

                        else -> error("Not supported")
                    }
                null -> null to QuantityUnit.Gram
            }
        }
    val servingQuantity =
        rememberFormField(
    ...
    val (defaultPackageQuantity, defaultPackageUnit) =
        remember(product) {
            when (val packageQuantity = product?.packageQuantity) {
                is AbsoluteQuantity.Volume ->
                    when (packageQuantity.volume.unit) {
                        VolumeUnit.Milliliters ->
                            packageQuantity.volume.milliliters to QuantityUnit.Milliliter

                        VolumeUnit.FluidOunces ->
                            packageQuantity.volume.fluidOunces to QuantityUnit.FluidOunce
                    }

                is AbsoluteQuantity.Weight ->
                    when (packageQuantity.weight.unit) {
                        WeightUnit.Grams -> packageQuantity.weight.grams to QuantityUnit.Gram

                        WeightUnit.Ounces -> packageQuantity.weight.ounces to QuantityUnit.Ounce

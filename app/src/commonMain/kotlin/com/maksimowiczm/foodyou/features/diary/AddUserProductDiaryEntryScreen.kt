...
) : FoodUiScope, FoodUiScopeWithImage, FoodUiScopeWithDiaryInput, FoodUiScopeWithNote {

    override val packageQuantity = product.packageQuantity
    override val servingQuantity = product.servingQuantity
    override val note = product.note
}

@Composable
private fun AddUserProductDiaryEntryScope.Screen(
    onBack: () -> Unit,
    onAdd: () -> Unit,
    onEdit: () -> Unit,
    onDelete: () -> Unit,

...
include(":feature3:settings:database")
include(":feature3:home")
include(":feature3:goals")
include(":feature3:food:shared")
include(":feature3:food:product")
include(":feature3:food:recipe")
include(":feature3:food:diary:shared")
include(":feature3:food:diary:search")
include(":feature3:food:diary:add")
include(":feature3:food:diary:update")

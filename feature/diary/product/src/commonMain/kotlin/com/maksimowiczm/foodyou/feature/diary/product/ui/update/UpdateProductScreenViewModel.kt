...
import com.maksimowiczm.foodyou.feature.diary.product.ui.ProductFormState
...
internal class UpdateProductScreenViewModel(
    ...
    val product = runBlocking { productRepository.getProductById(productId) }

    private val eventBus = MutableStateFlow<UpdateProductEvent?>(null)
    val events = eventBus.filterNotNull()

    fun onUpdate(productForm: ProductFormState) = launch {

...
import com.maksimowiczm.foodyou.feature.diary.product.ui.ProductForm
...
internal fun UpdateProductScreen(
    ...
    val productFormState = rememberProductFormState(product)
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                ...
                actions = {
                    TextButton(
                        onClick = { onUpdate(productFormState) },

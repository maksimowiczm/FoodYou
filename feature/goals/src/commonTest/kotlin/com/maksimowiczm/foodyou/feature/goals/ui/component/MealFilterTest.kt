...
class MealFilterTest {
    private val breakfast = testMeal(id = 1, name = "Breakfast")

    private val lunch = testMeal(id = 2, name = "Lunch")

    private val dinner = testMeal(id = 3, name = "Dinner")

    private val meals = setOf(breakfast, lunch, dinner)

    @Test
    fun test_initial() = runComposeUiTest {
        setContent { MealsFilter(state = rememberMealsFilterState(meals)) }

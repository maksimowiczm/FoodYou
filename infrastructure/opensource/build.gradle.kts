...
buildConfig {
    packageName("com.maksimowiczm.foodyou.app.infrastructure.opensource")
...
kotlin {
    ...
    androidLibrary {
        namespace = "com.maksimowiczm.foodyou.app.infrastructure.opensource"
    ...
    val xcfName = "infrastructure:opensourceKit"

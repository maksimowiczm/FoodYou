...
//                title = {
//                    val headline = (uiState as?
// FoodDetailsUiState.WithData)?.headline(nameSelector)
//
//                    if (headline != null) {
//                        Text(headline)
//                    } else {
...
//                        is FoodProductIdentity.FoodDataCentral -> RefreshMenu(onRefresh =
// onRefresh)
...
//
//            // TODO
//            //  These aren't really possible if we are accessing it from food list, leave it for
// now
